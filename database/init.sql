-- Script compatible con Railway/MySQL cuando ya estás dentro de la base de datos seleccionada.
-- No incluye CREATE DATABASE ni USE para evitar apuntar a una base incorrecta en producción.
